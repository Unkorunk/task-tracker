...
int main(int argc, char *argv[])
{
    ...
    http_server.route("/task/properties/get",    &Task::GetProperties   );
    http_server.route("/task/properties/add",    &Task::AddProperties   );
    http_server.route("/task/properties/remove", &Task::RemoveProperties);
